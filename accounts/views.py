...
class UserRegisterVerifyCodeView(View):
    ...
    def post(self,request):
        ...
        expiry_time = (code_instance.created + datetime.timedelta(minutes=2))
        if timezone.now() > expiry_time:
            code_instance.delete()
            messages.error(request,'Code has expired, please register again.')
        ...
        if form.is_valid():
            ...
            if cd ['code'] == code_instance.code:
                ...
                code_instance.delete()
                messages.success(request, 'You have successfully verified', 'success')
...
class UserLoginVerifyCodeView(View):
    form_class = VerifyCodeForm
    template_name = 'accounts/lverify.html'
